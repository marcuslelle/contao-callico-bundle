...
namespace Marcuslelle\ContaoCallicoBundle\Controller\FrontendModule;
...
/**
 * Class CallicoListingModuleController
 *
 * @FrontendModule(CallicoListingModuleController::TYPE, category="callico_modules", template="mod_callico_listing_module")
 */
class CallicoListingModuleController extends AbstractFrontendModuleController
{
    public const TYPE = 'callico_listing_module';
